public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Removing data from 1 instead of 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: inserting at the beginning not the end
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // Add not insert
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; // Should start at 0 not 1
        _queue.RemoveAt(0); // Also start at 0 not 1
        return value;
    }
}